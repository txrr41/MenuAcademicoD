...
begin
 ...
 id := StrToInt(Copy(nome, 1, Pos(' -', nome) - 1));
  ...
  FormEditarDisciplinas.CarregarDisciplina(id); // Método que carrega os dados
  FormEditarDisciplinas.ShowModal;
  FormEditarDisciplinas.Free;

  ListarDisciplinaClick(nil)
end;
